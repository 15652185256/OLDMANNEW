...
#pragma mark - 筛查 其他
        ...
        //查询 评估基本信息
        /*
        if ([[FMDBManager shareManager]selectPingGuJBByShenFenZJ:self.shenFenZJ].count>0) {
            NSLog(@"存在！");
            
            //修改 评估基本信息
            [[FMDBManager shareManager]updatePingGuJBByShenFenZJ:self.shenFenZJ dict:parameter];
        } else {
            NSLog(@"不存在！");
            
            //添加 评估基本信息
            [[FMDBManager shareManager]addPingGuJBData:parameter];
        }
        
        
        //删除 评估基本信息
        //[[FMDBManager shareManager]deletePingGuJBByShenFenZJ:self.shenFenZJ];
        */
