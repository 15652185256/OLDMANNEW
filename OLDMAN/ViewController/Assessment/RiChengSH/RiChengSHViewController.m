...
-(void)update_RiChengSH
{
    ...
    //查询 日常生活能力
    /*
    if ([[FMDBManager shareManager]selectRiChengSHByShenFenZJ:self.shenFenZJ].count>0) {
        NSLog(@"存在！");
        
        //修改 日常生活能力
        [[FMDBManager shareManager]updateRiChengSHByShenFenZJ:self.shenFenZJ dict:parameter];
    } else {
        NSLog(@"不存在！");
        
        //添加 日常生活能力
        [[FMDBManager shareManager]addRiChengSHData:parameter];
    }
    
    
    //删除 日常生活能力
    //[[FMDBManager shareManager]deleteRiChengSHByShenFenZJ:self.shenFenZJ];
     */
