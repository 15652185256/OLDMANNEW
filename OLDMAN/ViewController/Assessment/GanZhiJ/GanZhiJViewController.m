...
-(void)update_GanZhiJ
{
    ...
    //查询 感知觉与沟通
    /*
    if ([[FMDBManager shareManager]selectGanZhiJByShenFenZJ:self.shenFenZJ].count>0) {
        NSLog(@"存在！");
        
        //修改 感知觉与沟通
        [[FMDBManager shareManager]updateGanZhiJByShenFenZJ:self.shenFenZJ dict:parameter];
    } else {
        NSLog(@"不存在！");
        
        //添加 感知觉与沟通
        [[FMDBManager shareManager]addGanZhiJData:parameter];
    }
    
    
    //删除 感知觉与沟通
    //[[FMDBManager shareManager]deleteGanZhiJByShenFenZJ:self.shenFenZJ];
     */
