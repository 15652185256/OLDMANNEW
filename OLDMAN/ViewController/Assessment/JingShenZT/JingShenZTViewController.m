...
-(void)update_JingShenZT
{
    ...
    //查询 精神状态
    /*
    if ([[FMDBManager shareManager]selectJingShenZTByShenFenZJ:self.shenFenZJ].count>0) {
        NSLog(@"存在！");
        
        //修改 精神状态
        [[FMDBManager shareManager]updateJingShenZTByShenFenZJ:self.shenFenZJ dict:parameter];
    } else {
        NSLog(@"不存在！");
        
        //添加 精神状态
        [[FMDBManager shareManager]addJingShenZTData:parameter];
    }
    
    
    //删除 精神状态
    //[[FMDBManager shareManager]deleteJingShenZTByShenFenZJ:self.shenFenZJ];
     */
