...
-(void)update_WaiBuTG
{
    ...
    //查询 外部提供的专业看护服务
    /*
    if ([[FMDBManager shareManager]selectWaiBuTGByShenFenZJ:self.shenFenZJ].count>0) {
        NSLog(@"存在！");
        
        //修改 外部提供的专业看护服务
        [[FMDBManager shareManager]updateWaiBuTGByShenFenZJ:self.shenFenZJ dict:parameter];
    } else {
        NSLog(@"不存在！");
        
        //添加 外部提供的专业看护服务
        [[FMDBManager shareManager]addWaiBuTGData:parameter];
    }
    
    
    //删除 外部提供的专业看护服务
    //[[FMDBManager shareManager]deleteWaiBuTGByShenFenZJ:self.shenFenZJ];
     */
