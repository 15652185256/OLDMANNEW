...
#pragma mark - 居住 详细地址
    ...
    //查询 家庭主要照护者信息
    /*
    if ([[FMDBManager shareManager]selectJiaTingZHByShenFenZJ:self.shenFenZJ].count>0) {
        NSLog(@"存在！");
        
        //修改 家庭主要照护者信息
        [[FMDBManager shareManager]updateJiaTingZHByShenFenZJ:self.shenFenZJ dict:parameter];
    } else {
        NSLog(@"不存在！");
        
        //添加 家庭主要照护者信息
        [[FMDBManager shareManager]addJiaTingZHData:parameter];
    }
    
    
    //删除 家庭主要照护者信息
    //[[FMDBManager shareManager]deleteJiaTingZHByShenFenZJ:self.shenFenZJ];
     */
