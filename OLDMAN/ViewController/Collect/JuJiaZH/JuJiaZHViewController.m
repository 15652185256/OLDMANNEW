...
#pragma mark - 居住 详细地址
    ...
    //查询 居家照护管理员
    /*
    if ([[FMDBManager shareManager]selectJuJiaZHByShenFenZJ:self.shenFenZJ].count>0) {
        NSLog(@"存在！");
        
        //修改 居家照护管理员
        [[FMDBManager shareManager]updateJuJiaZHByShenFenZJ:self.shenFenZJ dict:parameter];
    } else {
        NSLog(@"不存在！");
        
        //添加 居家照护管理员
        [[FMDBManager shareManager]addJuJiaZHData:parameter];
    }
    
    
    //删除 居家照护管理员
    //[[FMDBManager shareManager]deleteJuJiaZHByShenFenZJ:self.shenFenZJ];
     */
