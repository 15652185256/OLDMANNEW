...
#pragma mark - 电子邮箱
    ...
    //查询 监护人信息
    /*
    if ([[FMDBManager shareManager]selectJianHuRenXXByShenFenZJ:self.shenFenZJ].count>0) {
        NSLog(@"存在！");
        
        //修改 监护人信息
        [[FMDBManager shareManager]updateJianHuRenXXByShenFenZJ:self.shenFenZJ dict:parameter];
    } else {
        NSLog(@"不存在！");
        
        //添加 监护人信息
        [[FMDBManager shareManager]addJianHuRenXXData:parameter];
    }
    
    
    //删除 监护人信息
    //[[FMDBManager shareManager]deleteJianHuRenXXByShenFenZJ:self.shenFenZJ];
     */
