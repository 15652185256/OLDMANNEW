...
#pragma mark - 住宅电话
        UIAlertView * alertView = [[UIAlertView alloc]initWithTitle:@"请输入正确的7位“住宅电话号码”" message:nil delegate:nil cancelButtonTitle:@"确定" otherButtonTitles: nil];
        [alertView show];
...
#pragma mark - 电子邮箱
    ...
    //查询 个人信息
    /*
    if ([[FMDBManager shareManager]selectGeRenXXByShenFenZJ:self.shenFenZJ].count>0) {
        NSLog(@"存在！");
        
        //修改 个人信息
        [[FMDBManager shareManager]updateGeRenXXByShenFenZJ:self.shenFenZJ dict:parameter];
    } else {
        NSLog(@"不存在！");
        
        //添加 个人信息
        [[FMDBManager shareManager]addGeRenXXData:parameter];
    }
    
    //删除 个人信息
//    [[FMDBManager shareManager]deleteGeRenXXByShenFenZJ:self.shenFenZJ];
     */
