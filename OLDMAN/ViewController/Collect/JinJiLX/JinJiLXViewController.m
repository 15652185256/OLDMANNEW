...
#pragma mark - 电子邮箱
    ...
    //查询 紧急联系人
    /*
    if ([[FMDBManager shareManager]selectJinJiLXByShenFenZJ:self.shenFenZJ].count>0) {
        NSLog(@"存在！");
        
        //修改 紧急联系人
        [[FMDBManager shareManager]updateJinJiLXByShenFenZJ:self.shenFenZJ dict:parameter];
    } else {
        NSLog(@"不存在！");
        
        //添加 紧急联系人
        [[FMDBManager shareManager]addJinJiLXData:parameter];
    }
    
    
    //删除 紧急联系人
    //[[FMDBManager shareManager]deleteJinJiLXByShenFenZJ:self.shenFenZJ];
     */
