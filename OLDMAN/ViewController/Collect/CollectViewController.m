...
{    
    ...
    [NetRequestClass NetRequestPOSTWithRequestURL:getUserStateForCollectionHttp WithParameter:parameter WithReturnValeuBlock:^(id returnValue) {
        ...
        if ([returnValue[@"success"] intValue]==1) {
            ...
            if ([returnValue[@"data"] isKindOfClass:[NSArray class]]) {
                ...
                NSUserDefaults * user = [NSUserDefaults standardUserDefaults];
                [CollectionDict setObject:[user objectForKey:doc_id] forKey:@"doc_id"];
                
                [CollectionDict setObject:self.shenFenZJ forKey:@"shenFenZJ"];
                ...
                for (NSDictionary * arr in returnValue[@"data"]) {
                    ...
                    switch ([code intValue]) {
                        case 0:
                            ...
                            [CollectionDict setObject:state forKey:@"yongHuQZ"];
                            break;
                        case 1:
                            _collectModel.shenFenXX=state;
                            [CollectionDict setObject:state forKey:@"shenFenXX"];
                            break;
                        case 2:
                            _collectModel.geRenXX=state;
                            [CollectionDict setObject:state forKey:@"geRenXX"];
                            break;
                        case 3:
                            _collectModel.jianHuRenXX=state;
                            [CollectionDict setObject:state forKey:@"jianHuRenXX"];
                            break;
                        case 38:
                            _collectModel.jinJiLX=state;
                            [CollectionDict setObject:state forKey:@"jinJiLX"];
                            break;
                        case 4:
                            _collectModel.muQianZK=state;
                            [CollectionDict setObject:state forKey:@"muQianZK"];
                            break;
                        case 5:
                            _collectModel.yiQueZhenJB=state;
                            [CollectionDict setObject:state forKey:@"yiQueZhenJB"];
                            break;
                        case 6:
                            _collectModel.jiaTingZH=state;
                            [CollectionDict setObject:state forKey:@"jiaTingZH"];
                            break;
                        case 7:
                            _collectModel.waiBuTG=state;
                            [CollectionDict setObject:state forKey:@"waiBuTG"];
                            break;
                        case 8:
                            _collectModel.xinXiCJ=state;
                            [CollectionDict setObject:state forKey:@"xinXiCJ"];
                            break;
                        case 9:
                            _collectModel.juJiaZH=state;
                            [CollectionDict setObject:state forKey:@"juJiaZH"];
                            break;
                ...
                //查询 采集各个小项状态
                /*
                if ([[FMDBManager shareManager]selectCollectionByShenFenZJ:self.shenFenZJ].count>0) {
                    NSLog(@"存在！");
                    
                    //修改 采集各个小项状态
                    [[FMDBManager shareManager]updateCollectionByShenFenZJ:self.shenFenZJ dict:parameter];
                } else {
                    NSLog(@"不存在！");
                    
                    //添加 采集各个小项状态
                    [[FMDBManager shareManager]addCollectionData:parameter];
                }
                 */
            }
