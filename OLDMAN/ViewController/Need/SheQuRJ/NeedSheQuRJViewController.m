...
-(void)update_SheQuRJ
{
    ...
    //查询 社区日间照料
    /*
    if ([[FMDBManager shareManager]selectSheQuRJByShenFenZJ:self.shenFenZJ].count>0) {
        NSLog(@"存在！");
        
        //修改 社区日间照料
        [[FMDBManager shareManager]updateSheQuRJByShenFenZJ:self.shenFenZJ dict:parameter];
    } else {
        NSLog(@"不存在！");
        
        //添加 社区日间照料
        [[FMDBManager shareManager]addSheQuRJData:parameter];
    }
