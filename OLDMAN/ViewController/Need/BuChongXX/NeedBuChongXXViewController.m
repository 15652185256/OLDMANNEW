...
#pragma mark - 补充信息
    ...
    //查询 补充信息
    /*
    if ([[FMDBManager shareManager]selectBuChongXXByShenFenZJ:self.shenFenZJ].count>0) {
        NSLog(@"存在！");
        
        //修改 补充信息
        [[FMDBManager shareManager]updateBuChongXXByShenFenZJ:self.shenFenZJ dict:parameter];
    } else {
        NSLog(@"不存在！");
        
        //添加 补充信息
        [[FMDBManager shareManager]addBuChongXXData:parameter];
    }
    
    
    //删除 补充信息
    //[[FMDBManager shareManager]deleteBuChongXXByShenFenZJ:self.shenFenZJ];
     */
