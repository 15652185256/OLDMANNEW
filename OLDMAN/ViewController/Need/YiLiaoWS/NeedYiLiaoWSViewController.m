...
-(void)update_YiLiaoWS
{
    ...
    //查询 医疗卫生
    /*
    if ([[FMDBManager shareManager]selectYiLiaoWSByShenFenZJ:self.shenFenZJ].count>0) {
        NSLog(@"存在！");
        
        //修改 医疗卫生
        [[FMDBManager shareManager]updateYiLiaoWSByShenFenZJ:self.shenFenZJ dict:parameter];
    } else {
        NSLog(@"不存在！");
        
        //添加 医疗卫生
        [[FMDBManager shareManager]addYiLiaoWSData:parameter];
    }
    
    
    //删除 医疗卫生
    //[[FMDBManager shareManager]deleteYiLiaoWSByShenFenZJ:self.shenFenZJ];
     */
