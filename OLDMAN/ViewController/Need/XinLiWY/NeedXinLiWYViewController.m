...
-(void)update_XinLiWY
{
    ...
    //查询 心理及文娱活动
    /*
    if ([[FMDBManager shareManager]selectXinLiWYByShenFenZJ:self.shenFenZJ].count>0) {
        NSLog(@"存在！");
        
        //修改 心理及文娱活动
        [[FMDBManager shareManager]updateXinLiWYByShenFenZJ:self.shenFenZJ dict:parameter];
    } else {
        NSLog(@"不存在！");
        
        //添加 心理及文娱活动
        [[FMDBManager shareManager]addXinLiWYData:parameter];
    }
    
    
    //删除 心理及文娱活动
    //[[FMDBManager shareManager]deleteXinLiWYByShenFenZJ:self.shenFenZJ];
     */
