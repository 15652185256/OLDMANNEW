...
//    }
    ...
    //查询 养老助餐调研
    /*
    if ([[FMDBManager shareManager]selectYangLaoZCByShenFenZJ:self.shenFenZJ].count>0) {
        NSLog(@"存在！");
        
        //修改 养老助餐调研
        [[FMDBManager shareManager]updateYangLaoZCByShenFenZJ:self.shenFenZJ dict:parameter];
    } else {
        NSLog(@"不存在！");
        
        //添加 养老助餐调研
        [[FMDBManager shareManager]addYangLaoZCData:parameter];
    }
    
    
    //删除 养老助餐调研
    //[[FMDBManager shareManager]deleteYangLaoZCByShenFenZJ:self.shenFenZJ];
     */
