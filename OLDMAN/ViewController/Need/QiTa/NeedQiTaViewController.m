...
-(void)update_QiTa
{
    ...
    //查询 其他
    /*
    if ([[FMDBManager shareManager]selectQiTaByShenFenZJ:self.shenFenZJ].count>0) {
        NSLog(@"存在！");
        
        //修改 其他
        [[FMDBManager shareManager]updateQiTaByShenFenZJ:self.shenFenZJ dict:parameter];
    } else {
        NSLog(@"不存在！");
        
        //添加 其他
        [[FMDBManager shareManager]addQiTaData:parameter];
    }
    
    
    //删除 其他
    //[[FMDBManager shareManager]deleteQiTaByShenFenZJ:self.shenFenZJ];
     */
