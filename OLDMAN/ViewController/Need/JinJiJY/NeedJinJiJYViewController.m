...
-(void)update_JinJiJY
{
    ...
    //查询 紧急救援
    /*
    if ([[FMDBManager shareManager]selectJinJiJYByShenFenZJ:self.shenFenZJ].count>0) {
        NSLog(@"存在！");
        
        //修改 紧急救援
        [[FMDBManager shareManager]updateJinJiJYByShenFenZJ:self.shenFenZJ dict:parameter];
    } else {
        NSLog(@"不存在！");
        
        //添加 紧急救援
        [[FMDBManager shareManager]addJinJiJYData:parameter];
    }
    
    
    //删除 紧急救援
    //[[FMDBManager shareManager]deleteJinJiJYByShenFenZJ:self.shenFenZJ];
     */
