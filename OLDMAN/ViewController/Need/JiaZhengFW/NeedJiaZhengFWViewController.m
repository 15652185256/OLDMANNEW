...
-(void)update_JiaZhengFW
{
    ...
    //查询 家政服务
    /*
    if ([[FMDBManager shareManager]selectJiaZhengFWByShenFenZJ:self.shenFenZJ].count>0) {
        NSLog(@"存在！");
        
        //修改 家政服务
        [[FMDBManager shareManager]updateJiaZhengFWByShenFenZJ:self.shenFenZJ dict:parameter];
    } else {
        NSLog(@"不存在！");
        
        //添加 家政服务
        [[FMDBManager shareManager]addJiaZhengFWData:parameter];
    }
    
    
    //删除 家政服务
    //[[FMDBManager shareManager]deleteJiaZhengFWByShenFenZJ:self.shenFenZJ];
     */
