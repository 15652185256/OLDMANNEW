...
#pragma mark - 营养膳食
    ...
    //查询 营养膳食
    /*
    if ([[FMDBManager shareManager]selectYingYangSSByShenFenZJ:self.shenFenZJ].count>0) {
        NSLog(@"存在！");
        
        //修改 营养膳食
        [[FMDBManager shareManager]updateYingYangSSByShenFenZJ:self.shenFenZJ dict:parameter];
    } else {
        NSLog(@"不存在！");
        
        //添加 营养膳食
        [[FMDBManager shareManager]addYingYangSSData:parameter];
    }
    
    
    //删除 营养膳食
    //[[FMDBManager shareManager]deleteYingYangSSByShenFenZJ:self.shenFenZJ];
     */
