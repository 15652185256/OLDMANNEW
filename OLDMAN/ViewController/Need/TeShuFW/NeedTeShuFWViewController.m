...
-(void)update_TeShuFW
{
    ...
    //查询 特殊服务需求
    /*
    if ([[FMDBManager shareManager]selectTeShuFWByShenFenZJ:self.shenFenZJ].count>0) {
        NSLog(@"存在！");
        
        //修改 特殊服务需求
        [[FMDBManager shareManager]updateTeShuFWByShenFenZJ:self.shenFenZJ dict:parameter];
    } else {
        NSLog(@"不存在！");
        
        //添加 特殊服务需求
        [[FMDBManager shareManager]addTeShuFWData:parameter];
    }
    
    
    //删除 特殊服务需求
    //[[FMDBManager shareManager]deleteTeShuFWByShenFenZJ:self.shenFenZJ];
     */
