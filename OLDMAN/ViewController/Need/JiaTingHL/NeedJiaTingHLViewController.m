...
#pragma mark - 家庭护理
    ...
    //查询 家庭护理
    /*
    if ([[FMDBManager shareManager]selectJiaTingHLByShenFenZJ:self.shenFenZJ].count>0) {
        NSLog(@"存在！");
        
        //修改 家庭护理
        [[FMDBManager shareManager]updateJiaTingHLByShenFenZJ:self.shenFenZJ dict:parameter];
    } else {
        NSLog(@"不存在！");
        
        //添加 家庭护理
        [[FMDBManager shareManager]addJiaTingHLData:parameter];
    }
    
    
    //删除 家庭护理
    //[[FMDBManager shareManager]deleteJiaTingHLByShenFenZJ:self.shenFenZJ];
     */
